...
const struct SpeciesInfo gSpeciesInfo[] =
{
	...
	[SPECIES_MEDICHAM_LASERIAN] =
	{
		...
		.weight = 315,
		.description = COMPOUND_STRING(
			"As its psychic powers strengthen,\n"
			"Medicham develops pyrokinesis for\n"
			"use in its performances. It creates\n"
			"fireballs to juggle and hurl at its foes."),
		.pokemonScale = 298,
        .pokemonOffset = 5,
        .trainerScale = 256,
        .trainerOffset = 0,
		.frontPic = gMonFrontPic_Medicham_Laserian,
		.frontPicSize = MON_COORDS_SIZE(48, 63),
		.frontPicYOffset = 0,
		.frontAnimFrames = ANIM_FRAMES(
            ANIMCMD_FRAME(0, 7),
            ANIMCMD_FRAME(1, 7),
		...
		.frontAnimDelay = 5,
		.backPic = gMonBackPic_Medicham_Laserian,
		.backPicSize = MON_COORDS_SIZE(60, 64),
		.backPicYOffset = 0,
		.backAnimId = BACK_ANIM_CONCAVE_ARC_SMALL,
		.palette = gMonPalette_Medicham_Laserian,
		.shinyPalette = gMonShinyPalette_Medicham_Laserian,
		.iconSprite = gMonIcon_Medicham_Laserian,
		.iconPalIndex = 0,
